...
``` typescript
import pkg from 'https://unpkg.com/rfc-log-levels@^3.11.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/rfc-log-levels/^3.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/rfc-log-levels@^3.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/rfc-log-levels@3.11.0'
</script>
```
